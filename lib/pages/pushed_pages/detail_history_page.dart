...
class _HistoryDetailPageState extends State<HistoryDetailPage> {
  ...
  void _navigateToItemDetail() {
    ...
    WasteCategory? wasteCategory = _findWasteCategory(
      _history.classificationResult,
    );
        ...
        MaterialPageRoute(
          builder:
              (context) => ItemDetailPage(
                ...
                description:
                    'Informasi detail tentang ${_history.classificationResult}. Item ini dapat didaur ulang untuk membantu lingkungan.',
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (wasteCategory != null &&
                      wasteCategory.price != _history.price)
                    _buildDetailRow(
